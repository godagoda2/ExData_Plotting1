plot4 <- function(){
  ...
  par(mfrow = c(2,2))
  with(data3,{
    plot(dt,Global_active_power,type ="l",pch ="NA_integer_",xlab = "",ylab = "Global Active Power (kilowatts)")
    plot(dt,Voltage,type ="l",pch ="NA_integer_",xlab = "datetime",ylab = "Voltage")
  })
  ...
  with(data3,plot(dt,Global_active_power,type="h",xlab="datetime",ylab="Global Active Power (kilowatts)"))
  dev.off()
